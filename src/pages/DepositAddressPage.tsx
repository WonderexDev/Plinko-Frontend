      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center text-lg">
            <span className="text-purple-300 mr-1">{icons[crypto.icon]}</span>
        ...
        <div className=" p-1 rounded-xl mb-4">
          <div className="relative bg-[#3a2a40] rounded-lg p-3 mb-2 flex flex-row justify-between items-center">
            <div className="flex flex-col items-start mb-1 w-[70%]">
              <div className="flex items-center mb-1">
                <span className="text-purple-300 mr-1">
                  {icons[crypto.icon]}
                </span>
                <span className="text-sm overflow-hidden">
                  {amount} Deposit Address
                </span>
              </div>
              <div className="text-2xl text-gray-300 w-[90%] overflow-hidden text-ellipsis whitespace-nowrap">
                {depositAddress}
              </div>
            ...
            <div className="flex flex-col items-end justify-between ml-2 w-[30%] gap-1">
              <button className="bg-[#4a3a50]  text-white text-xs p-3 rounded-md flex items-center gap-2">
                <Copy className="w-4 h-4" />
                Address
              </button>
              <button
                onClick={() => navigate(-1)}
                className="bg-[#4a3a50]  text-white text-xs p-3 px-7 rounded-md flex items-center gap-1"
              >
                Cancel
              </button>
            </div>
